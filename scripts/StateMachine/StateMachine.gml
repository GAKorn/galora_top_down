...
Autor: Sohom Sahaun | @sohomsahaum
*/

///@func			StateMachine(initial_state, [state_name, state_struct])
///@param			{string} initial_state		Initial state fot the state machine
...
function StateMachine(_state) constructor {
	...
	///@param		{bool}		perf				If enter/leave should be performed | Default: true
	///@param		{func}		leave_function		Custom function for leave event of current state | Default: -1
	///@param		{func}		enter_function		Custom function for enter event of current state | Default: -1
	///@returns		N/A
